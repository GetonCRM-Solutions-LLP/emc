...
export default class ReportList extends NavigationMixin(LightningElement) {
    ...
    modalcontentmessage = 'Make sure all mileage has been reviewed and approved.Once the report is generated,you can not approve/flag mileage for this reimbursement report.';
    ...
    handledownloadsummary(){
        if(this.currentReport == 'Time, Attendance and Mileage Summary Report'){
            if(this.payperioddate){
                window.open("https://"+window.location.host+"/app/TimeandSummaryDetailReport?id="+this._accid+"&endDate="+this.payperioddate.split(' - ')[0]+"&startDate="+this.payperioddate.split(' - ')[1])
            }
            this.payperioddropdown = false; 
        }else if(this.currentReport == 'Bi-Weekly Payment Report'){
            if(this.payperioddate){
                window.open("https://"+window.location.host+"/app/PayDateReport?id="+this._accid+"&endDate="+this.payperioddate.split(' - ')[0]+"&startDate="+this.payperioddate.split(' - ')[1])
            }
            this.payperioddropdown = false; 
        }else if(this.currentReport == 'Variable Reimbursement Report'){
            if(this.payperioddate){
            ...
            if(this.payperioddate){
                window.open("https://"+window.location.host+"/app/TimeSheetNetchexReport?id="+this._accid+"&startDate="+this.payperioddate.split(' - ')[1]+"&endDate="+this.payperioddate.split(' - ')[0])
            }
            this.payperioddropdown = false; 
            this.byweeksubmit = false;
        }  else if(this.currentReport == 'Biweekly Mileage Reimbursement Report'){
